            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    ...
                    <div class="contact-form">
                        <form action="{{ route('contact.sendEnquiry') }}" method="POST" id="fruitkha-contact">
                            @csrf
                            <p>
							...
							@enderror
                            <p>
                                <textarea name="contentMessage" id="message" cols="30" rows="10" placeholder="Message"></textarea>
                            </p>
